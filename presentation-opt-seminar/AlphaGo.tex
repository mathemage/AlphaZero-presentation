...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  
  {
    ...
    \begin{frame}{AlphaGo versus Ke Jie?}
      ...
      \begin{itemize}[<+- | alert@+>]
        \item professional 9 dan 
        \item the $1^{st}$ in (R\'{e}mi Coulom's unofficial) world ranking list
        \item a~professional Go player at age 11
        \item head-to-head record versus Lee Sedol \textbf{8:2}
        \item biological neural network comparable to Fan Hui's, and by transitivity, also comparable to Lee Sedol's
      \end{itemize}
    \end{frame}
  }
