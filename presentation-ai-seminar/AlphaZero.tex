...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{AlphaGo Zero (AG0)}
  {
    ...
    \begin{frame}{Self-Play Reinforcement Learning in AG0}
      \pause
      \begin{center}
    ...
    \begin{frame}{Monte Carlo Tree Search (1/2)}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...

  {
    ...
    \begin{frame}{Tournament between AI Programs}
      \begin{center}
