...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...

  {
    ...
    \begin{frame}{Deep Neural Network: Inspiration}
      ...
      \begin{center}
        \tiny
        The notion of~hierarchy is captured in~the~number of~layers (the~\textbf{deep} in~``\textbf{deep} learning'')
    ...
    \begin{frame}{Convolutional Neural Network}
      \begin{center}
        \includegraphics[width=.8\textwidth]{../img/ConvNet_hierarchy.png}
      \end{center}
    \end{frame}
  }
