...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{AlphaGo: Inside Out}
  {
    ...
    \begin{frame}{SL policy networks (2/2)}
      ...
      \end{center}
      \vskip -1ex
      Move probabilities directly from the SL policy network $p_\sigma$ (reported as a~percentage if above $0.1\%$).
    \end{frame}
    ...
    \begin{frame}{Principal variation}
      %\framesubtitle{(path with maximum visit count) from the search tree}
