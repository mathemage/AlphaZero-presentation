...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{Neural networks}
  {
    ...
    \begin{frame}{Neural Network: Inspiration}
      ...
      \begin{itemize}[<+- | alert@+>]
          %\tiny
        \item inspired by~the neuronal structure of~the mamalian cerebral cortex
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \section{AlphaGo: Inside Out}
  {
    ...
    \begin{frame}{Evalutation accurary in~various stages of a~game}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{frame}{AlphaGo versus Fan Hui}
    ...
    \end{center}
    AlphaGo \textbf{won 5 - 0} in a~formal match on~October 2015.
    \pause
...

  {
    ...
    \begin{frame}{AlphaGo versus Lee Sedol}
      ...
      \epigraph{
        \tiny
        ...even beating AlphaGo by 4-1 may allow the Google DeepMind team to claim its de facto victory and the defeat of him, or even humankind.
