...
\begin{description}
  \item [Policy network] is a~CNN selecting moves.
    ...
    % TODO Add labels of policy networks
    \begin{description}
      \item [SL policy network] is trained by supervised learning from expert human moves.
      \item [RL policy network] is trained by reinforcement learning, namely by optimizing self-play.
    \end{description}

    % TODO The output probability predicts the winner of~games played by the RL policy network against itself.
